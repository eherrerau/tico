	...
	while($rowSchbyUsr = sqlsrv_fetch_array($getSchByUsr)){
		...
		//if (($scheduleIn < date("H:i")) and ($scheduleOut >= date("H:i")) and !((date("H:i") >= $scheduleLunch)and(date("H:i") < $scheduleLunchOff))){	
			...
			If ($rowpremier = sqlsrv_fetch_array($getpremier)){
				...
				$usrPremier = "<img src=\"images/premier.png\" width=\"12\" height=\"12\" alt=\"Premier\" title=\"Premier\"/>";
				else
				$usrPremier=""; 
				$contador=$contador+1;
							...
							//-----------WFH------------
								...
								If ($rowWFH = sqlsrv_fetch_array($getWFH)){
									...
									if ($rowWFH['schExcepTypeId']==3){
										echo "<img src=\"images/sick.gif\" width=\"15\" height=\"15\" alt=\"Sick\" title=\"Sick\">";
									}
									if ($rowWFH['schExcepTypeId']==4){
										echo "<img src=\"images/permission.gif\" width=\"15\" height=\"15\" alt=\"On Permission\" title=\"On Permission\">";
									}
									if ($rowWFH['schExcepTypeId']==5){
										echo "<img src=\"images/ooq.gif\" width=\"15\" height=\"15\" alt=\"OOQ\" title=\"OOQ\">";
									}
